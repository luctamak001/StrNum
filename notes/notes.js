...
// Predict in comments:
// 1) "5" + 2 -> my "guess" 52
// 2) "5" - 2 -> my guess crash
// 3) 10 / "2" -> my guess crash
// 4) "Hello".length -> 5
// 5) "Hello"[1] -> my guess e
...
// The + operator with a string usually does string joining (concatenation) (not math).
// Other operators like -, *, / often try to apply math to numbers.
...
// Common quotes: '  "  and ` (backticks) for making a string literal.
...
// slice(a, b) = substring from index a up to (but not including) index b
